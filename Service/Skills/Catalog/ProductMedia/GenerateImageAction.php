...
/**
 * Generates a new product image with Higgsfield Marketing Studio Image, using the main image as
 * reference.
 */
class GenerateImageAction extends AbstractGenerateAction
{
    public const ENDPOINT = 'marketing-studio/image';
    public const ASPECT_RATIOS = ['1:1', '3:2', '2:3', '4:3', '3:4', '16:9', '9:16', '21:9'];
    ...
    {
        return 'Start generating a new image of an existing product from its main image (costs Higgsfield '
            . 'credits, the admin confirms). Returns a request_id; the image itself comes from check_status';
    }
